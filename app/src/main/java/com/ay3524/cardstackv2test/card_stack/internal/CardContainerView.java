...
public class CardContainerView extends FrameLayout {
    ...
    public interface ContainerEventListener {
        ...
        void onCardSwipedDown(float translationValueY);
    }
...
//        ViewCompat.setTranslationX(this, viewOriginX + event.getRawX() - motionOriginX);
        float translationValueY = viewOriginY + event.getRawY() - motionOriginY;
        if(translationValueY < 0){
            ViewCompat.setTranslationY(this, translationValueY);
            Log.e(CardContainerView.class.getSimpleName(),"Swiped Up");
        } else {
            if (containerEventListener != null) {
                containerEventListener.onCardSwipedDown(translationValueY);
            }
            Log.e(CardContainerView.class.getSimpleName(),"Swiped Down");
        }
    }
