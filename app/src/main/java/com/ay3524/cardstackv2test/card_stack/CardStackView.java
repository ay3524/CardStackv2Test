package com.ay3524.cardstackv2test.card_stack;
...
import com.ay3524.cardstackv2test.R;
import com.ay3524.cardstackv2test.card_stack.internal.CardContainerView;
import com.ay3524.cardstackv2test.card_stack.internal.CardStackOption;
import com.ay3524.cardstackv2test.card_stack.internal.CardStackState;
import com.ay3524.cardstackv2test.card_stack.internal.SwipedItem;
import com.ay3524.cardstackv2test.card_stack.internal.Util;
...
public class CardStackView extends FrameLayout {
    ...
    private CardContainerView.ContainerEventListener containerEventListener = new CardContainerView.ContainerEventListener() {
        ...
        @Override
        public void onCardSwipedDown(float translationValueY) {
            reverse(translationValueY);
        }
    };
...
//                .translationX(topView.getViewOriginX())
    ...
    public void reverse(float translationValueY) {
        reverse(true,translationValueY);
    }

    public void reverse(boolean directionLimit, float translationValueY) {
